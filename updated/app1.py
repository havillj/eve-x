...
vFam = {'Arenaviridae': ['Lassa mammarenavirus'], 'Rhabdoviridae': ['Culex ohlsrhavirus', 'Ohlsdorf ohlsrhavirus', 'Culex tritaeniorhynchus rhabdovirus', 'Tongilchon ohlsrhavirus', 'Merida virus', 'Riverside virus 1', 'Radi vesiculovirus', 'Xingshan alphanemrhavirus', 'Malpais Spring vesiculovirus', 'Drosophila melanogaster sigmavirus', 'Gata virus', 'Inhangapi virus', 'Yinshui bat virus', 'Culex rhabdovirus', 'Guadeloupe Culex rhabdovirus', 'Grenada mosquito rhabdovirus 1', 'Chinese rice-field eel rhabdovirus', 'Yata ephemerovirus', 'Perinet vesiculovirus', 'New Kent County virus', 'Yongjia ledantevirus', 'Island sawgrhavirus'], 'Xinmoviridae': ['Aedes anphevirus', 'Aedes aegypti anphevirus', 'Aedes albopictus anphevirus', 'Xincheng anphevirus'], 'Orthomyxoviridae': ['Wuhan Mosquito Virus 6'], 'Sedoreovirinae': ['Liao ning virus'], 'Flaviviridae': ['Xishuangbanna aedes flavivirus', 'Aedes flavivirus', 'Pestivirus A', 'La Tina virus', 'Culiseta flavivirus', 'Zika virus', 'Mercadeo virus', 'Ochlerotatus scapularis flavivirus', 'Cell fusing agent virus', 'Parramatta River virus', 'West Nile virus', 'Menghai flavivirus', 'Ochlerotatus caspius flavivirus', 'Culex flavivirus', 'Kamiti River virus', 'Quang Binh virus', 'Dengue virus', 'Tick-borne encephalitis virus', 'Culex Flavi-like virus', 'Nienokoue virus', 'Mac Peak virus', 'Mansonia flavivirus', 'Sabethes flavivirus', 'Japanese encephalitis virus', 'Barkedji virus'], 'Totiviridae': ['Australian Anopheles totivirus', 'Fitzroy Crossing toti-like virus 1'], 'Phenuiviridae': ['Phasi Charoen-like phasivirus'], 'Paramyxoviridae': ['Avian orthoavulavirus 1'], 'Bromoviridae': ['Alfalfa mosaic virus', 'American plum line pattern virus', 'Prunus necrotic ringspot virus'], 'Nodaviridae': ['Culex mosquito virus 2'], 'Mononegavirales': ['Serbia mononega-like virus 1'], 'Pneumoviridae': ['Human orthopneumovirus']}
