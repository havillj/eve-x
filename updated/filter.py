...
#path = os.path.abspath("results/xml/Bangkok_Thailand_15.LIN210A1693_hits.xml")
#print(path)
...
for i in contigs:
    ...
    for index in range(len(left)):
        ...
        if firstRight < lastLeft:
            if i in overlaps:
                overlaps[i].append((lastLeft, firstRight, Lrev, Rrev, lastLeft - firstRight, acc))
            else:
                overlaps[i] = [(lastLeft, firstRight, Lrev, Rrev, lastLeft - firstRight, acc)]
