...
def writeToTSV():
    """Writes overlap data to a TSV file
    ...
    with open("overlaps.tsv", "w") as outfile:
        ...
        tsv_writer.writerow(["Chromosome","Node", "Accession ID", "End Position", "Start Position", "Sequence Overlap", "Left Overlap", "Right Overlap"])
